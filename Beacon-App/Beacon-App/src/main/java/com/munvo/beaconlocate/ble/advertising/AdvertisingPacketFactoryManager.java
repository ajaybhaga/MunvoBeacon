package com.munvo.beaconlocate.ble.advertising;
...
public class AdvertisingPacketFactoryManager {
    ...
    // System.out: createAdvertisingPacket(): advertisingPacketFactory -> com.nexenio.bleindoorpositioning.ble.advertising.IBeaconAdvertisingPacketFactory@fec878b
    //System.out.println("createAdvertisingPacket(): advertisingPacketFactory -> " + advertisingPacketFactory);
